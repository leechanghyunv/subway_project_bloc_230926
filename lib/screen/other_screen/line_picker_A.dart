...
class LinePickerA extends StatelessWidget {

  final String value;

   LinePickerA({super.key, required this.value});
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    context.read<CodeBloc>().add(
                        CodeEvent.started(value,lineNumber));
                    context.read<SubInfoFilterBloc>().add(
                        SubInfoFilterEvent.filtedAfter(value,lineNumber));
