...
SearchArrival _$SearchArrivalFromJson(Map<String, dynamic> json) {
  return _SearchArrival.fromJson(json);
}

/// @nodoc
mixin _$SearchArrival {
  @JsonKey(name: 'realtimeArrivalList')
  List<ArrivalModel>? get arrival => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $SearchArrivalCopyWith<SearchArrival> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SearchArrivalCopyWith<$Res> {
  factory $SearchArrivalCopyWith(
          SearchArrival value, $Res Function(SearchArrival) then) =
      _$SearchArrivalCopyWithImpl<$Res, SearchArrival>;
  @useResult
  $Res call(
      {@JsonKey(name: 'realtimeArrivalList') List<ArrivalModel>? arrival});
}

/// @nodoc
class _$SearchArrivalCopyWithImpl<$Res, $Val extends SearchArrival>
    implements $SearchArrivalCopyWith<$Res> {
  _$SearchArrivalCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_SearchArrivalCopyWith<$Res>
    implements $SearchArrivalCopyWith<$Res> {
  factory _$$_SearchArrivalCopyWith(
          _$_SearchArrival value, $Res Function(_$_SearchArrival) then) =
      __$$_SearchArrivalCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'realtimeArrivalList') List<ArrivalModel>? arrival});
...
/// @nodoc
class __$$_SearchArrivalCopyWithImpl<$Res>
    extends _$SearchArrivalCopyWithImpl<$Res, _$_SearchArrival>
    implements _$$_SearchArrivalCopyWith<$Res> {
  __$$_SearchArrivalCopyWithImpl(
      _$_SearchArrival _value, $Res Function(_$_SearchArrival) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_SearchArrival implements _SearchArrival {
  const _$_SearchArrival(
      {@JsonKey(name: 'realtimeArrivalList') final List<ArrivalModel>? arrival})
      : _arrival = arrival;

  factory _$_SearchArrival.fromJson(Map<String, dynamic> json) =>
      _$$_SearchArrivalFromJson(json);
  ...
  @override
  String toString() {
    return 'SearchArrival(arrival: $arrival)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_arrival));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_SearchArrivalCopyWith<_$_SearchArrival> get copyWith =>
      __$$_SearchArrivalCopyWithImpl<_$_SearchArrival>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SearchArrivalToJson(
      this,
    );
  }
}

abstract class _SearchArrival implements SearchArrival {
  const factory _SearchArrival(
      {@JsonKey(name: 'realtimeArrivalList')
      final List<ArrivalModel>? arrival}) = _$_SearchArrival;

  factory _SearchArrival.fromJson(Map<String, dynamic> json) =
      _$_SearchArrival.fromJson;
