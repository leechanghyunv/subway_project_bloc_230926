...
/// @nodoc
@JsonSerializable()
class _$_DistModel with DiagnosticableTreeMixin implements _DistModel {
  const _$_DistModel(
      {this.latA = "정보없음",
      this.lngA = "정보없음",
      this.nameA = "정보없음",
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'DistModel'))
      ..add(DiagnosticsProperty('latA', latA))
      ..add(DiagnosticsProperty('lngA', lngA))
      ..add(DiagnosticsProperty('nameA', nameA))
      ..add(DiagnosticsProperty('latB', latB))
      ..add(DiagnosticsProperty('lngB', lngB))
      ..add(DiagnosticsProperty('nameB', nameB));
  }
